...
const Skills = () => {
  return (
    <section id="skills" className="border-b-2 pb-40">
      <h2 className="text-3xl font-bold mb-4">Skills</h2>
      <div className="text-2xl mb-3">Programming Languages & Tools:</div>
      <div className="flex flex-row flex-wrap gap-2">
        <i class="devicon-javascript-plain colored text-7xl"></i>
        <i class="devicon-nodejs-plain-wordmark colored text-7xl"></i>
        <i class="devicon-express-original colored text-7xl"></i>
        <i class="devicon-mongodb-plain-wordmark colored text-7xl"></i>
        <i class="devicon-postman-plain colored text-7xl"></i>
        ...
        <i class="devicon-redux-original colored text-7xl"></i>
        <i class="devicon-html5-plain colored text-7xl"></i>
        <i class="devicon-css3-plain colored text-7xl"></i>
        <svg className="w-20 h-20 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
        ...
        <i class="devicon-reactrouter-plain colored text-7xl"></i>
        <i class="devicon-reactbootstrap-original colored text-7xl"></i>
        <i class="devicon-git-plain colored text-7xl"></i>
        <i class="devicon-github-plain colored text-7xl"></i>
        <i class="devicon-vercel-original colored text-7xl"></i>
        ...
        <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/figma/figma-original.svg" className="w-20 h-20" />
        <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/vitejs/vitejs-original.svg" className="w-20 h-20"/>
      </div>
    </section>
  )
}
