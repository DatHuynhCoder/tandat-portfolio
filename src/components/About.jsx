...
const About = () => {
  return (
    <section id="about" className="border-b-2 pb-20 md:pb-40">
      <h1 className="text-4xl md:text-5xl font-bold mb-4">HUYNH TAN DAT</h1>
      <div className="flex flex-row gap-3 items-center">
        <FaAddressCard fontSize={24} color="#34495e" className="min-w-6" />
        <div className="text-xl md:text-2xl font-medium">Web Developer</div>
      </div>
      <div className="flex flex-row gap-3 mt-4 items-center">
        <FaMapMarkedAlt fontSize={24} color="#34495e" className="min-w-6" />
        <div className="text-xl md:text-2xl font-medium">Linh Trung ward, Ho Chi Minh City, Viet Nam</div>
      </div>
      ...
      <p className="flex flex-row gap-3 items-center mb-2">
        <img src={gmail_icon} alt="gmail icon" className="w-5 h-5 md:w-6 md:h-6" />
        <a href="mailto:htdat2004@gmail.com" className="underline text-base md:text-xl hover:text-red-950 underline-offset-6">htdat2004@gmail.com</a>
      </p>

      <p className="flex flex-row gap-3 items-center mb-2">
        <img src={facebook_icon} alt="facebook icon" className="w-5 h-5 md:w-6 md:h-6" />
        <a href="https://www.facebook.com/huynh.tan.at.979563/" target="_blank" className="underline text-base md:text-xl hover:text-red-950 underline-offset-6">My Facebook</a>
      </p>

      <p className="flex flex-row gap-3 items-center mb-2">
        <img src={github_icon} alt="facebook icon" className="w-5 h-5 md:w-6 md:h-6" />
        <a href="https://github.com/DatHuynhCoder" target="_blank" className="underline text-base md:text-xl hover:text-red-950 underline-offset-6">My Github</a>
      </p>

      <p>
        <em className="text-xl md:text-2xl font-medium">"If you don't swing, you will never hit a Home run!"</em>
      </p>
    </section>
  )
}
