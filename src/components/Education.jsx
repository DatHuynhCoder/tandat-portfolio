const Education = () => {
  return (
    <section id="education" className="border-b-2 pb-40">
      <h2 className="text-3xl font-bold mb-4">Education</h2>
      <h3 className="text-2xl text-green-800 font-bold hover:underline hover:text-emerald-600"><a href="https://www.uit.edu.vn/">University of Information Technology – UIT</a></h3>
      <p className="text-lg font-medium">I am currently a third-year student majoring in Information Technology at UIT – Vietnam National University, Ho Chi Minh City. My current GPA is <b>8.66</b></p>
